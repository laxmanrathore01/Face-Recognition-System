...
class Face_Recognition_System:
    def __init__(self, root):
        ...
        # Detect Face Button
        img5 = Image.open("Images/face2.jpg")
        ...
        # Attendance Button
        img6 = Image.open("Images/face2.jpg")
        ...
        # Help Button  
        img7 = Image.open("Images/face2.jpg")
        ...
        # Train Face Button
        img8 = Image.open("Images/face2.jpg")
        img8 = img8.resize((220,220),Image.LANCZOS)
        self.photoImg8 = ImageTk.PhotoImage(img8)
        b1 = Button(bg_img, image=self.photoImg8, cursor="hand2")
        b1.place(x=200, y=380, width=220, height=220)

        b1 = Button(bg_img, text="Train Data", cursor="hand2",font=("times new roman", 15, "bold"), bg="blue", fg="white")
        b1.place(x=200, y=580, width=220, height=40)



        # Photos Button
        img9 = Image.open("Images/face2.jpg")
        ...
        # Developer Button
        img10 = Image.open("Images/face2.jpg")
        ...
        # Exit Button
        img11 = Image.open("Images/face2.jpg")
